...
cd /home && wget https://www.dropbox.com/s/mtwz66ccqocyyeb/Xtream_Codes_v1.0.60_Nulled.zip
...
echo -e "${jeshile} └─────────────────────────────────────────┘ \e[0m"
echo " "
cp /etc/init.d/xtreamcodes_pro_panel /etc/init.d/xtreamcodes_pro_panel_backup_by_SRT
echo -e "${jeshile} [+] /etc/init.d/xtreamcodes_pro_panel Backup as xtreamcodes_pro_panel_backup_by_SRTCS \e[0m"
...
cp /etc/rc.local /etc/rc.local_backup_by_SRT
echo -e "${jeshile} [+] /etc/rc.local backuped as rc.local_backup_by_SRTCS \e[0m"
...
echo " "
#MYSQL CONFIG, ALL ORIGINAL FILES ARE BACKUP WITH END backup_by_SRT
echo -e "${jeshile} ┌──────────────────────────────┐ \e[0m"
echo -e "${jeshile} │  Modified MYSQL Connections  │ \e[0m"
echo -e "${jeshile} └──────────────────────────────┘ \e[0m"
echo " "
cp /etc/mysql/my.cnf /etc/mysql/my_config.cnf_backup_by_SRT
echo -e "${jeshile} [+] /etc/mysql/my.cnf backuped as my.cnf_backup_by_SRTCS \e[0m"
...
echo -e "${jeshile} └───────────────────────┘ \e[0m"
echo " "
rm /home/Xtream_Codes_v1.0.60_Nulled.zip
echo " "
echo -e "${jeshile} ┌──────────────────────────────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │  Xtream Fuckers 10.60 Nulled By SRTCS 				   │ \e[0m"
echo -e "${jeshile} └──────────────────────────────────────────────────────────┘ \e[0m"
echo -e "${jeshile} ┌──────────────────────────────────────────────────────────┐ \e[0m"
